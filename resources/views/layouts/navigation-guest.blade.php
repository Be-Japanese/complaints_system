        ...
        <div class="flex h-16 justify-between">
            ...
            <div class="flex">
                <button id="theme-toggle" type="button"
                    class="me-4 rounded-lg p-2.5 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-700">
